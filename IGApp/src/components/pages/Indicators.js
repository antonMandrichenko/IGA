...
import {getIndicatorIcon, getIndicatorsWithProps} from 'components/utils/indicators';
...
class Indicators extends Component {
  ...
  newFunnelShowJourneys = funnelStage => {
    ...
    const metricsCustomFilters = get(CRMConfig, ['metricsCustomFilters', funnelStage], []);

    navigateWithFilters(funnelStage, metricsCustomFilters);
  };
