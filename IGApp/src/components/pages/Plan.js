...
export default class Plan extends Component {
  ...
  render() {
    ...
    const childrenWithProps = React.Children.map(this.props.children,
      (child) => {
        const {plan, forecastedIndicators, calculatedData, historyData, planDate, fiscalYearFirstMonth, userRegions, actualChannelBudgets, updateState, addUnknownChannel, channelsImpact, updateUserMonthPlan, region} = this.props;
