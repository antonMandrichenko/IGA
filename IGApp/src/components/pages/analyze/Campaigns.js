...
import CampaignCards from'components/pages/analyze/CampaignCards';
    ...
    return (
      <div>
        ...
        <CampaignCards 
          ...
          campaignData={this.getData(attributionCampaigns)}
          getItemCost={item => item.cost}/>
        <FeatureToggle featureName='attribution'>
          <>
            <div className={this.classes.rows}>
              <GeneratedImpact
                  data={campaignsImpactByFrequency}
