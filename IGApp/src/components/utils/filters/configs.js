...
export const channelsPageConfig = [channelsConfig, customFieldsConfig, crmSourceConfig, productConfig, regionConfig]
export const campaignsPageConfig = [channelsConfig, campaignsConfig, customFieldsConfig, crmSourceConfig, productConfig, regionConfig]
export const contentPageConfig = [contentConfig, customFieldsConfig, crmSourceConfig, productConfig, regionConfig]
